<div class="navbar">
   <div class="navbar-inner">
      <ul class="nav nav-pills">
         ...
         <li><?= $this->Html->link('Step 3a: ' . __('Google Translate'), ['action' => 'googletranslate'],['title' => 'Machine translation using Google API']) ?></li>
         <li><?= $this->Html->link('Step 3b: ' . __('Manual Translate'), ['action' => 'index'],['title' => 'Edit each language item in the list below']) ?></li>
         <li><?= $this->Html->link('Step 4: ' . __('Export'), ['action' => 'export'],['title' => 'Export translations to po-Files']) ?></li>
      </ul>
   </div>
</div>
